...
const We = Object.getOwnPropertyNames
const Je = Object.prototype.hasOwnProperty
const Me = (e, n) => {
		for (const i in n) he(e, i, { get: n[i], enumerable: !0 })
	};
	const Ge = (e, n, i, t) => {
		if ((n && typeof n == 'object') || typeof n == 'function')
			for (const r of We(n))
				!Je.call(e, r) &&
					r !== i &&
					he(e, r, { get: () => n[r], enumerable: !(t = je(n, r)) || t.enumerable })
		return e
	}
const Xe = (e) => Ge(he({}, '__esModule', { value: !0 }), e)
const Yn = {}
Me(Yn, {
	Decimal: () => He,
	Public: () => pe,
...
const Ke = () => {
	...
	const Ye = () => !!globalThis.Deno;
	const ze = () => typeof globalThis.Netlify == 'object';
	const ye = () => typeof globalThis.EdgeRuntime == 'object';
	const en = () => {
		let e
...
const H = 9e15;
	...
	let Z;
	let w = !0;
	const ue = '[DecimalError] ';
	const $ = `${ue  }Invalid argument: `;
	const De = `${ue  }Precision limit exceeded`;
	const Fe = `${ue  }crypto unavailable`;
	const Ie = '[object Decimal]';
	const R = Math.floor;
	const C = Math.pow;
	const rn = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i;
	const sn = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i;
	const on = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i;
	const Le = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i;
	const F = 1e7;
	const m = 7;
	const un = 9007199254740991;
	const fn = re.length - 1;
	const Ee = se.length - 1;
	const h = { toStringTag: Ie }
...
h.comparedTo = h.cmp = function (e) {
	let n;
		...
		const s = this;
		const o = s.d;
		const u = (e = new s.constructor(e)).d;
		const c = s.s;
		const f = e.s
...
h.logarithm = h.log = function (e) {
	...
	if (((i = f.d), f.s < 0 || !i || !i[0] || f.eq(1)))
		return new l(i && !i[0] ? -1 / 0 : f.s != 1 ? Number.NaN : i ? 0 : 1 / 0)
	if (n)
		if (i.length > 1) s = !0
		else {
	...
	if (((e = new v(e)), !g.d || !e.d))
		return (
			!g.s || !e.s
				...
				: g.d
					? (e.s = -e.s)
					: (e = new v(e.d || g.s !== e.s ? g : Number.NaN)),
			e
		)
...
h.plus = h.add = function (e) {
	...
	if (((e = new d(e)), !a.d || !e.d))
		return !a.s || !e.s ? (e = new d(Number.NaN)) : a.d || (e = new d(e.d || a.s === e.s ? a : Number.NaN)), e
...
h.precision = h.sd = function (e) {
	let n;
		const i = this
	if (e !== void 0 && e !== !!e && e !== 1 && e !== 0) throw new Error($ + e)
	return i.d ? ((n = _e(i.d)), e && i.e + 1 > n && (n = i.e + 1)) : (n = Number.NaN), n
}
h.round = function () {
	const e = this;
		const n = e.constructor
...
h.squareRoot = h.sqrt = function () {
	...
	if (f !== 1 || !u || !u[0]) return new l(!f || (f < 0 && (!u || u[0])) ? Number.NaN : u ? o : 1 / 0)
	for (
		w = !1,
			f = Math.sqrt(+o),
			f == 0 || f == 1 / 0
...
h.times = h.mul = function (e) {
	...
	if (((e.s *= l.s), !d || !d[0] || !g || !g[0]))
		return new a(
			!e.s || (d && !d[0] && !g) || (g && !g[0] && !d) ? Number.NaN : !d || !g ? e.s / 0 : e.s * 0
		)
	for (
		i = R(l.e / m) + R(e.e / m),
			c = d.length,
...
h.toDecimalPlaces = h.toDP = function (e, n) {
	...
	return (
		...
		e === void 0
			? i
			: (A(e, 0, V), n === void 0 ? (n = t.rounding) : A(n, 0, 8), p(i, e + i.e + 1, n))
	)
}
...
h.toFraction = function (e) {
	...
	if (
		...
		if (((u = new N(e)), !u.isInt() || u.lt(f))) throw new Error($ + u)
		e = u.gt(n) ? (s > 0 ? n : f) : u
	}
	for (
...
h.toPower = h.pow = function (e) {
	let n;
		...
		const f = +(e = new c(e))
	if (!u.d || !e.d || !u.d[0] || !e.d[0]) return new c((+u)**f)
...
h.toString = function () {
	const e = this;
		const n = e.constructor;
		const i = L(e, e.e <= n.toExpNeg || e.e >= n.toExpPos)
...
function A(e, n, i) {
	if (e !== ~~e || e < n || e > i) throw new Error($ + e)
}
function K(e, n, i, t) {
	let r, s, o, u
					...
					(d = 0),
						...
						f < 0
							? ((Y = E[0]),
								...
								i(E, N, P, c),
								f == -1 &&
									((P = E.length), (f = n(S, E, D, P)), f < 1 && (d++, i(E, D < P ? y : S, P, c))),
								(P = E.length))
							: f === 0 && (d++, (E = [0])),
						(T[a++] = d),
...
function p(e, n, i, t) {
	...
	e: if (n != null) {
		...
		if (((s = n - r), s < 0))
			(s += m), (o = n), (l = a[(d = 0)]), (c = (l / 10**(r - o - 1)) % 10 | 0)
			...
			;(s %= m), (o = s - m + r), (c = o < 0 ? 0 : (l / 10**(r - o - 1)) % 10 | 0)
		}
		if (
			((t = t || n < 0 || a[d + 1] !== void 0 || (o < 0 ? l : l % 10**(r - o - 1))),
			(f =
				i < 4
					? (c || t) && (i == 0 || i == (e.s < 0 ? 3 : 2))
					: c > 5 ||
						(c == 5 &&
							(i == 4 ||
								t ||
								(i == 6 && (s > 0 ? (o > 0 ? l / 10**(r - o) : 0) : a[d - 1]) % 10 & 1) ||
								i == (e.s < 0 ? 8 : 7)))),
			n < 1 || !a[0])
		)
			return (
				(a.length = 0),
				f ? ((n -= e.e + 1), (a[0] = 10**((m - (n % m)) % m)), (e.e = -n || 0)) : (a[0] = e.e = 0),
				e
			)
		if (
			(s == 0
...
function oe(e, n, i) {
	if (n > fn) throw ((w = !0), i && (e.precision = i), new Error(De))
	return p(new e(re), n, 1, !0)
}
function I(e, n, i) {
	if (n > Ee) throw new Error(De)
...
function ke(e, n) {
	...
	for (n == null ? ((w = !1), (c = v)) : (c = n), u = new d(0.03125); e.e > -2; )
		(e = e.times(u)), (a += 5)
	for (
		t = ((Math.log(2**a) / Math.LN10) * 2 + 5) | 0,
			c += t,
			i = s = o = new d(1),
			d.precision = c;
		;
...
function B(e, n) {
	...
	if (N.s < 0 || !q || !q[0] || (!N.e && q[0] == 1 && q.length == 1))
		return new M(q && !q[0] ? -1 / 0 : N.s != 1 ? Number.NaN : q ? 0 : N)
	if (
		(n == null ? ((w = !1), (l = E)) : (l = n),
		(M.precision = l += v),
		(i = b(q)),
...
function ln(e, n) {
	...
	return s < 0
		...
		: ((e.e = fe(f, l)),
			...
			(w = !1),
			o && (e = k(e, r, u * 4)),
			c && (e = e.times(Math.abs(c) < 54 ? 2**c : Q.pow(2, c))),
			(w = !0),
			e)
}
function an(e, n) {
...
function Cn(e) {
	if (!e || typeof e != 'object') throw new Error(`${ue  }Object expected`)
	let n;
		let i;
		let t;
...
function Ve(e) {
	...
	function r(s) {
		...
		if (((c = typeof s), c === 'number')) {
			...
			if (s * 0 !== 0) {
				s || (f.s = Number.NaN), (f.e = Number.NaN), (f.d = null)
				return
			}
...
function $n(e) {
	...
	for (
		t = u[--s], e %= m, t && e && ((r = 10**(m - e)), (u[s] = ((t / r) | 0) * r));
		u[s] === 0;
		s--
	)
		u.pop()
