const ma = Object.create
const ar = Object.defineProperty
const da = Object.getOwnPropertyDescriptor
const fa = Object.getOwnPropertyNames
const ga = Object.getPrototypeOf;
	const ha = Object.prototype.hasOwnProperty
const ya = (e, t, r) =>
	t in e ? ar(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r)
const Re = (e, t) => () => (e && (t = e((e = 0))), t)
const Le = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports);
	const nn = (e, t) => {
		for (const r in t) ar(e, r, { get: t[r], enumerable: !0 })
	};
	const wa = (e, t, r, n) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (const i of fa(t))
				!ha.call(e, i) &&
					i !== r &&
					ar(e, i, { get: () => t[i], enumerable: !(n = da(t, i)) || n.enumerable })
		return e
	}
const We = (e, t, r) => (
	(r = e != null ? ma(ga(e)) : {}),
	wa(t || !e || !e.__esModule ? ar(r, 'default', { value: e, enumerable: !0 }) : r, e)
)
const w = (e, t, r) => ya(e, typeof t != 'symbol' ? `${t  }` : t, r)
let y;
	const u = Re(() => {
		'use strict'
		y = {
...
const Ci = Le((Ye) => {
	...
	p()
	m()
	const pi = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports);
		const Ea = pi((e) => {
			'use strict'
	...
	function sn(e) {
		const t = e.length < 0 ? 0 : un(e.length) | 0;
			const r = xe(t)
...
const Ka = { enabled: !Oi && Di == null && Mi !== 'dumb' && ((gn != null && gn !== '0') || Ni) }
function G(e, t) {
...
const Vm = G(0, 0);
	...
	const id = G(47, 49)
const za = 100;
	const $i = ['green', 'yellow', 'blue', 'magenta', 'cyan', 'red'];
	const dr = [];
	let Vi = Date.now();
	let Ya = 0;
	const hn = typeof y < 'u' ? y.env : {}
	...
	const t = {
		...
		const r = (...n) => {
			...
			if (
				...
				const l = n.map((g) => (typeof g == 'string' ? g : Xa(g)));
					const f = `+${Date.now() - Vi}ms`
				;(Vi = Date.now()), a(o, ...l, f)
			}
		}
	return new Proxy(r, { get: (n, i) => t[i], set: (n, i, o) => (t[i] = o) })
}
const ji = new Proxy(Za, { get: (e, t) => Tt[t], set: (e, t, r) => (Tt[t] = r) })
function Xa(e, t = 2) {
	const r = new Set()
...
var At = {
	...
	var io = { warn: () => !y.env.PRISMA_DISABLE_WARNINGS }
function Pl(...e) {
	console.log(...e)
}
function En(e, ...t) {
...
p()
m()
const xn = (e, t) => e.reduce((r, n) => ((r[t(n)] = n), r), {})
d()
u()
c()
p()
...
const tt = 9e15;
	...
	let ve;
	let _ = !0;
	const vr = '[DecimalError] ';
	const De = `${vr  }Invalid argument: `;
	const ho = `${vr  }Precision limit exceeded`;
	const yo = `${vr  }crypto unavailable`;
	const wo = '[object Decimal]';
	const X = Math.floor;
	const H = Math.pow;
	const Rl = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i;
	const Sl = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i;
	const kl = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i;
	const Eo = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i;
	const me = 1e7;
	const O = 7;
	const Il = 9007199254740991;
	const Ol = br.length - 1;
	const Cn = xr.length - 1;
	const A = { toStringTag: wo }
...
A.logarithm = A.log = function (e) {
	...
	if (
		...
		do
			if (
				((a += 10), (s = Oe(f, a)), (n = t ? Pr(g, a + 10) : Oe(e, a)), (l = V(s, n, a, 1)), !o)
			) {
...
A.precision = A.sd = function (e) {
	...
	return r.d ? ((t = bo(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = Number.NaN), t
}
A.round = function () {
	const e = this;
		const t = e.constructor
...
A.toDecimalPlaces = A.toDP = function (e, t) {
	...
	return (
		...
		e === void 0
			? r
			: (ie(e, 0, Me), t === void 0 ? (t = n.rounding) : ie(t, 0, 8), I(r, e + r.e + 1, t))
	)
}
...
var V = (function () {
	...
	return function (n, i, o, s, a, l) {
		let f;
			...
			let pe;
			let or;
			const sr = n.constructor;
			const rn = n.s == i.s ? 1 : -1;
			let Z = n.d;
			let j = i.d
		if (!Z || !Z[0] || !j || !j[0])
			return new sr(
...
function Pr(e, t, r) {
	if (t > Ol) throw ((_ = !0), r && (e.precision = r), new Error(ho))
	return I(new e(br), t, 1, !0)
}
function ge(e, t, r) {
	if (t > Cn) throw new Error(ho)
...
function Wl(e) {
	if (!e || typeof e != 'object') throw new Error(`${vr  }Object expected`)
	let t;
		let r;
		let n;
...
function Rr(e) {
	const t = e.showColors ? vu : Tu;
		let r
	return (
		typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = Cu(e)), Au(r, t)
	)
}
d()
u()
...
m()
const Ir = (e) => e;
	const Or = { bold: Ir, red: Ir, green: Ir, dim: Ir, enabled: !1 };
	const Oo = { bold: pr, red: Ze, green: Fi, dim: mr, enabled: !0 };
	const at = {
		write(e) {
			e.writeLine(',')
		},
...
function Vu(e, t) {
	...
	if (a)
		if (
			...
			const l = e.inputTypes.map(No).join(' | ')
...
const Mr = Symbol();
	...
	const Nt = class extends Ce {
		_getNamespace() {
			return 'NullTypes'
		}
	};
	const _t = class extends Nt {}
On(_t, 'DbNull')
const Ft = class extends Nt {}
On(Ft, 'JsonNull')
...
function $o(e) {
	...
	if (e instanceof Date) {
		const t = Ar(e) ? e.toISOString() : 'Invalid Date'
...
function Xu(e) {
	const t = new lt()
	for (const r of e) t.addItem($o(r))
	return t
}
function _r(e, t) {
	const r = t === 'pretty' ? Oo : Or;
		const n = e.renderAllMessages(r);
		const i = new st(0, { colors: r }).write(e).toString()
...
const nc = {
	...
	const Ho = 'explicitly `undefined` values are not allowed'
function _n({
	modelName: e,
	action: t,
	args: r,
...
function yc(e, t = ',', r = '', n = '') {
	...
	return new ue([r, ...Array.from({length: e.length - 1}).fill(t), n], e)
}
function Xo(e) {
	return new ue([e], [])
}
...
p()
m()
const $r = { enumerable: !0, configurable: !0, writable: !0 }
function Vr(e) {
	const t = new Set(e)
	return {
...
p()
m()
const is = { _avg: !0, _count: !0, _sum: !0, _min: !0, _max: !0 }
function ft(e = {}) {
	const t = vc(e)
	return Object.entries(t).reduce(
		(n, [i, o]) => (is[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n),
		{ select: {} }
	)
}
function vc(e = {}) {
...
p()
m()
const cs = (e) => (Array.isArray(e) ? e : e.split('.'));
	const $n = (e, t) => cs(t).reduce((r, n) => r && r[n], e);
	const ps = (e, t, r) =>
		cs(t).reduceRight((n, i, o, s) => Object.assign({}, $n(e, s.slice(0, o)), { [i]: n }), r)
function Sc(e, t) {
...
const Oc = [
	...
	const Dc = ['aggregate', 'count', 'groupBy']
function jn(e, t) {
...
function Mc(e, t) {
	const r = Ee(t);
		const n = Object.keys(gr.ModelAction).concat('count')
	return {
		getKeys() {
			return n
		},
...
const Gn = Symbol()
function Gt(e) {
	const t = [Fc(e), Lc(e), re(Gn, () => e), re('$parent', () => e._appliedParent)];
...
p()
m()
const Uc = ['$connect', '$disconnect', '$on', '$transaction', '$use', '$extends'];
	const ws = Uc
function Es(e) {
...
function Jt(e) {
	...
	if (Array.isArray(e)) {
		let t = e.length;
			let r
		for (r = new Array(t); t--; ) r[t] = Jt(e[t])
		return r
	}
	if (typeof e == 'object') {
		const t = {}
...
p()
m()
const jc = () => globalThis.process?.release?.name === 'node';
	const Gc = () => !!globalThis.Bun || !!globalThis.process?.versions?.bun;
	const Jc = () => !!globalThis.Deno;
	const Qc = () => typeof globalThis.Netlify == 'object';
	const Wc = () => typeof globalThis.EdgeRuntime == 'object';
	const Hc = () => globalThis.navigator?.userAgent === 'Cloudflare-Workers'
function Kc() {
	return (
		[
			[Qc, 'netlify'],
...
p()
m()
const Qn = 'This request could not be understood by the server';
	const Qt = class extends J {
		constructor(r, n, i) {
			super(n || Qn, q(r, !1))
...
p()
m()
const Yc = 'Interactive transaction error';
...
p()
m()
const Zc = 'Request parameters are invalid';
	const Zt = class extends J {
		constructor(r, n = Zc) {
			super(n, q(r, !1))
...
p()
m()
const Hn = 'Requested resource does not exist';
...
p()
m()
const zn = 'Unauthorized, check your connection string';
...
p()
m()
const Yn = 'Usage exceeded, retry again later';
...
const rp = /^[1-9]\d*\.\d+\.\d+$/;
	const Ns = ee('prisma:client:dataproxyEngine')
async function np(e, t) {
	const r = Ms['@prisma/engines-version'];
...
const Fs = 3;
	const Hr = ee('prisma:client:dataproxyEngine');
	const Xn = class {
...
function Ls({ copyEngine: e = !0 }, t) {
	...
	const n = !!(r?.startsWith('prisma://') || wn(r))
	e &&
		n &&
		yr(
			'recommend--no-engine',
...
function js(e) {
	...
	const t = {}
	for (const r of Object.keys(e)) t[r] = $s(e[r])
	return t
}
function $s(e) {
	return typeof e == 'bigint' ? e.toString() : js(e)
}
const sp = /^(\s*alter\s)/i;
	const Gs = ee('prisma:client')
function ei(e, t, r, n) {
...
const ap = yn.split('.')[0];
	...
	const ni = class {
		...
		getGlobalTracingHelper() {
			const t = globalThis[`V${ap}_PRISMA_INSTRUMENTATION`];
...
const pp = ee('prisma:client:request_handler');
	const Xr = class {
		constructor(t, r) {
			w(this, 'client')
			w(this, 'dataloader')
				...
				(this.dataloader = new Zr({
					batchLoader: vs(async ({ requests: n, customDataProxyFetch: i }) => {
						const { transaction: o, otelParentCtx: s } = n[0];
							...
							const f = n.some((h) => oi(h.protocolQuery.action))
						return (
					...
					singleLoader: async (n) => {
						const i = n.transaction?.kind === 'itx' ? Xs(n.transaction) : void 0;
...
const na = [
	...
	const ia = ['pretty', 'colorless', 'minimal'];
	const oa = ['info', 'query', 'warn', 'error'];
	const hp = {
...
Expected string or undefined.`)
		...
		omit: (e, t) => {
			...
			for (const [n, i] of Object.entries(e)) {
				const o = wp(n, t.runtimeDataModel)
				if (!o) {
...
function yp(e, t) {
	...
	const r = t.map((i) => ({ value: i, distance: (0, aa.default)(e, i) }))
...
function sa(e, t) {
	const r = Object.keys(e).find((n) => nt(n) === t)
	if (r) return e[r]
}
function Ep(e, t) {
	const r = pt(e)
	...
	const { message: n, args: i } = _r(r, 'colorless')
...
const Fe = ee('prisma:client')
typeof globalThis == 'object' && (globalThis.NODE_CLIENT = !0)
const bp = { requestArgsToMiddlewareArgs: (e) => e, middlewareArgsToRequestArgs: (e) => e };
	const xp = Symbol.for('prisma.client.transaction.id');
	const Pp = {
		id: 0,
		nextId() {
			return ++this.id
...
function vp(e) {
	class t {
		...
		_request(n) {
			...
			const i = n.middlewareArgsMapper ?? bp;
				const o = {
...
p()
m()
const export_warnEnvConflicts = void 0
export {
	rc as createParam,
	ji as Debug,
	Te as Decimal,
