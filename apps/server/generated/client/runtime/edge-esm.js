...
A.times = A.mul = function (e) {
	...
	if (((e.s *= g.s), !T || !T[0] || !k || !k[0]))
		return new h(
			!e.s || (T && !T[0] && !k) || (k && !k[0] && !T) ? NaN : !T || !k ? e.s / 0 : e.s * 0
		)
	for (
		r = X(g.e / O) + X(e.e / O),
			l = T.length,
...
function I(e, t, r, n) {
	...
	e: if (t != null) {
		...
		if (
			...
			return (
				(h.length = 0),
				f ? ((t -= e.e + 1), (h[0] = H(10, (O - (t % O)) % O)), (e.e = -t || 0)) : (h[0] = e.e = 0),
				e
			)
		if (
			(o == 0
	...
	return (
		_ && (e.e > k.maxE ? ((e.d = null), (e.e = NaN)) : e.e < k.minE && ((e.e = 0), (e.d = [0]))), e
	)
}
function he(e, t, r) {
...
function uu(e) {
	...
	for (
		n = a[--o], e %= O, n && e && ((i = H(10, O - e)), (a[o] = ((n / i) | 0) * i));
		a[o] === 0;
		o--
	)
		a.pop()
