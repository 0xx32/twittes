...
export namespace Prisma {
  ...
  */
	...
	export type PostOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
		$Extensions.GetOmit<
			'id' | 'title' | 'content' | 'image' | 'creatorId' | 'likes' | 'createdAt' | 'updatedAt',
			ExtArgs['result']['post']
		>
	...
	export type CommentOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
		$Extensions.GetOmit<
			'id' | 'text' | 'postId' | 'createdAt' | 'updatedAt',
			ExtArgs['result']['comment']
		>
	...
	export type PostCreateNestedManyWithoutCreatorInput = {
		create?:
			| XOR<PostCreateWithoutCreatorInput, PostUncheckedCreateWithoutCreatorInput>
			| PostCreateWithoutCreatorInput[]
			| PostUncheckedCreateWithoutCreatorInput[]
		connectOrCreate?:
			| PostCreateOrConnectWithoutCreatorInput
			| PostCreateOrConnectWithoutCreatorInput[]
	...
	export type PostUpdateManyWithoutCreatorNestedInput = {
		...
		update?:
			...
			| PostUpdateWithWhereUniqueWithoutCreatorInput[]
		updateMany?:
			| PostUpdateManyWithWhereWithoutCreatorInput
			| PostUpdateManyWithWhereWithoutCreatorInput[]
